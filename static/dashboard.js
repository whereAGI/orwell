    ...
    let html = `
        ...
        <div class="pdf-section">
            ...
            <div class="pdf-subtitle">
                Schema: <strong>${escapeHtml(report.schema_name || 'N/A')}</strong> |
...
function generateMarkdown(report) {
  ...
  md += `**Audit Schema:** ${report.schema_name || 'N/A'}\n`;
...
async function loadDimensions(schemaId) {
  try {
    ...
    if (!container) return;
    container.innerHTML = '';
    selectedDimensions = []; // Reset selected dimensions on schema change
